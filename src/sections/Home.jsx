...
import {delay, hover, motion, scale, time} from "framer-motion";
...
const roles = useMemo(()=> ["Java Developer","Software Developer","Backend Developer"])
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left realtive">
          <div className="w-full lg:pr-24 mx-auto max-w-[48rem]">
            ...
            >
              ...
              <span
                className="inline-block w-[2px] m1-1 bg-white animate-pulse align-middle"
                style={{ height: "1em" }}
              ></span>
            </motion.div>
            <motion.h1
            ...
            >
              Java Backend Developer focused on Spring Boot, Spring Security,
              Hibernate, JDBC, and MySQL. Proficient in Data Structures &
              Algorithms and experienced in developing RESTful APIs, real-time
              applications with WebSockets, and responsive interfaces using
              HTML, CSS, and JavaScript.
            </motion.p>

            <motion.div
              className="mt-10 flex flex-wrap items-center justify-center ;g:justify-start gap-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <a
                ...
                download="Vasu_Agarwal_Resume.pdf"
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 rounded-full font-medium text-lg text-black bg-white  animate delay-200 hover:bg-opacity-20 transition-all"
              >
                My Resume
              </a>
            </motion.div>
